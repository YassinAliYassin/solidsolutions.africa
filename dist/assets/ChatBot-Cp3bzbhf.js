import{n as e}from"./rolldown-runtime-CbXtAM7H.js";import{r as t,t as n}from"./react-vendor-BD62_gQY.js";import{n as r,t as i}from"./AnimatePresence-CbdnFqzu.js";import{o as a,p as o}from"./index-DU_7JU-V.js";import{t as s}from"./react-CSLeADo3.js";var c=o(`send`,[[`path`,{d:`M14.536 21.686a.5.5 0 0 0 .937-.024l6.5-19a.496.496 0 0 0-.635-.635l-19 6.5a.5.5 0 0 0-.024.937l7.93 3.18a2 2 0 0 1 1.112 1.11z`,key:`1ffxy3`}],[`path`,{d:`m21.854 2.147-10.94 10.939`,key:`12cjpa`}]]),l=e(t(),1),u=n(),d=[`What services do you offer?`,`Pricing?`,`How do I contact you?`,`Tell me about SolidAI`];function f(e){let t=e.toLowerCase();return t.includes(`price`)||t.includes(`cost`)||t.includes(`pricing`)||t.includes(`how much`)||t.includes(`fee`)||t.includes(`charge`)?`We offer scoped, SME-friendly pricing:
