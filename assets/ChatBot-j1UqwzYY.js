import{n as e}from"./rolldown-runtime-CbXtAM7H.js";import{r as t,t as n}from"./react-vendor-BD62_gQY.js";import{n as r,t as i}from"./AnimatePresence-CTpvDSs5.js";import{o as a,p as o}from"./index-CXJBsOkb.js";import{t as s}from"./react-CSLeADo3.js";var c=o(`send`,[[`path`,{d:`M14.536 21.686a.5.5 0 0 0 .937-.024l6.5-19a.496.496 0 0 0-.635-.635l-19 6.5a.5.5 0 0 0-.024.937l7.93 3.18a2 2 0 0 1 1.112 1.11z`,key:`1ffxy3`}],[`path`,{d:`m21.854 2.147-10.94 10.939`,key:`12cjpa`}]]),l=e(t(),1),u=n(),d=[`What services do you offer?`,`Pricing?`,`How do I contact you?`,`Tell me about SolidAI`];function f(e){let t=e.toLowerCase();return t.includes(`price`)||t.includes(`cost`)||t.includes(`pricing`)||t.includes(`how much`)||t.includes(`fee`)||t.includes(`charge`)?`We quote to the work — websites, SolidAI agents, and cloud setup are scoped to your team and budget.

Payment plans are available for SMEs. Email info@solidsolutions.africa and we will send a clear quote.`:t.includes(`contact`)||t.includes(`reach`)||t.includes(`email`)||t.includes(`phone`)||t.includes(`call`)||t.includes(`get in touch`)?`Reach Solid Solutions at:
...
Want a walkthrough? Email info@solidsolutions.africa.`:t.includes(`roadmap`)||t.includes(`road map`)||t.includes(`future plan`)||t.includes(`what's next`)||t.includes(`whats next`)?`Current focus:
...
Tell me which track you care about and I will point you to the right next step.`:t.includes(`solidai`)||t.includes(`solid llm`)||t.includes(`solidllm`)||t.includes(`language model`)||t.includes(`chatbot`)||/\bai\b/.test(t)||t.includes(`agent`)||t.includes(`llm`)?`SolidAI is our sector-specific agent platform:
...
Each agent is built for day-to-day business support. Request early access at /beta or email info@solidsolutions.africa.`:t.includes(`who are you`)||t.includes(`what is solid`)||t.includes(`about solid`)||t.includes(`about you`)||t.includes(`mission`)||t.includes(`vision`)||t.includes(`your story`)?`Solid Solutions is an African tech company building practical AI, cloud, and web systems for SMEs.
...
Which area interests you?`:`Thanks for your message — I'm the Solid Solutions assistant.
